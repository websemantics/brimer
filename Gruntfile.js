/*!
 * Brimer's Gruntfile (based on Bootstrap)
 * http://websemantics.github.io/brimer
  ...
  grunt.initConfig({
    ...
    babel: {
      ...
      dist: {
        ...
        files: {
          '<%= concat.brimer.dest %>' : '<%= concat.brimer.dest %>'
        }
      }
    },
    ...
    cssmin: {
      options: {
        ...
        //    and then simplify the fix for https://github.com/twbs/brimer/issues/14837 accordingly
        compatibility: 'ie9',
        keepSpecialComments: '*',
        sourceMap: true,
        advanced: false
    ...
    buildcontrol: {
      ...
      pages: {
        options: {
          remote: 'git@github.com:websemantics/brimer.git',
          branch: 'gh-pages'
        }
      }
    },
